...
typedef NS_ENUM(NSInteger, EISerialStopBits) {
	EIStopbitsOne           = 0,
	EIStopbitsTwo           = 1
};

typedef NS_ENUM(NSInteger, EISerialParity) {
	EIParityNone            = 0,
	EIParityOdd             = 1,
	EIParityEven            = 2
};

typedef NS_ENUM(NSInteger, EISerialFlowControl) {
    EIFlowControlNone       = 0,
    EIFlowControlXonXoff    = 1,
    EIFlowControlHardware   = 2
};

typedef NS_ENUM(NSInteger, EISerialDataBits) {
    EIDataBitsFive          = 0,
    EIDataBitsSix           = 1,
    EIDataBitsSeven         = 2,
    EIDataBitsEight         = 3
...
typedef NS_ENUM(NSInteger, EISerialPortType) {
